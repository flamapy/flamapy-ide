...
// panel and the right model-info panel; a gear at the bottom opens the compute
// backend settings. Active toggles get the accent left border, like VSCode.
...
function ActivityBar({ sidebarOpen, onToggleSidebar, modelInfoOpen, onToggleModelInfo, onOpenBackend }) {
  return (
